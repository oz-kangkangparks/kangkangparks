...
const services = [
  ...
  },
  {
    ...
    title: 'WEB SYSTEM',
    titleKo: '웹 시스템 개발',
    subtitle: 'ERP·MES·그룹웨어·CMS 등 30+ 프로젝트를 성공적으로 구축했습니다.\n기획부터 운영까지 전 과정을 책임집니다.',
  ...
  },
  {
    ...
    title: 'MOBILE APP',
    titleKo: '모바일 앱',
    subtitle: '한 번 개발로 iOS·Android 동시 출시합니다.\n앱스토어 심사부터 배포까지 전 과정을 책임집니다.',
...
export default function SimpleServices() {
  ...
  return (
    <section id="services" className="relative bg-black py-16">
          ...
          <div className="flex-1">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative w-full lg:w-[500px] lg:h-[500px] aspect-square">
                  {/* SVG Progress Circle */}
                  <svg className="absolute inset-0 w-full h-full -rotate-90">
                    ...
                    <motion.circle
                      ...
                      animate={isHovered ? { strokeDasharray: "0 100" } : { strokeDasharray: "100 100" }}
                  ...
                  <div className="absolute inset-2 rounded-full overflow-hidden">
                    <Image
                      ...
                      alt={services[activeService].titleKo}
                      fill
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p className="text-lg lg:text-xl text-neutral-400 mb-12 leading-relaxed whitespace-pre-line">
                  ...
                  <a
                    href="#contact"
                    className="inline-flex items-center justify-center px-10 py-4 border-2 border-white text-white font-medium rounded-full hover:bg-white hover:text-black transition-all"
                  >
                    MORE VIEW +
                  </a>
                </div>
